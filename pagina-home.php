                ...
                <div class="hero-content">
                    <div class="hero-text">
                        ...
                        <div class="hero-buttons">
                            <button class="btn-primary">Explorar Soluções</button>
                            <button class="btn-secondary">Fale com um Especialista</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="stats-content">
                    ...
                    <div class="stats-right">
                        ...
                        <button class="btn-stats">Saiba Mais Sobre Nós</button>
                    </div>
                </div>
            </div>
        </section>
